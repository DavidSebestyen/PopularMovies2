...
public class MovieDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String CREATE_TABLE = "CREATE TABLE " + MovieContract.MovieEntry.TABLE_NAME + " (" +
                ...
                MovieContract.MovieEntry.COLUMN_ID + " INTEGER NO NULL," +
                ...
                MovieContract.MovieEntry.COLUMN_COVER + " TEXT NOT NULL, " +
                MovieContract.MovieEntry.COLUMN_POPULAR + " INTEGER DEFAULT 0,  " +
                MovieContract.MovieEntry.COLUMN_TOP_RATED + " INTEGER DEFAULT 0,  " +
